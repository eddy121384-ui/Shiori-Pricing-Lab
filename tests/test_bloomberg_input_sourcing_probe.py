...
from bloomberg_dapi_probe import ProbeFieldResult  # noqa: E402
...
def test_collect_evidence_sends_overrides_only_with_the_option_context_request():
    ...
    collect_evidence(("US91282CLJ89",), (("SOME_FIELD", "SOME_VALUE"),), probe=probe)
...
def test_a_failed_request_still_produces_every_report_row():
    ...
    report = build_report(
        collect_evidence(("US91282CLJ89", "GB00BFX0ZL78"), (), probe=probe), (), _GENERATED_AT
    )
...
def _default_report():
    ...
    evidence = collect_evidence(module.DEFAULT_IDENTIFIERS, (), probe=probe)
    return build_report(evidence, (), _GENERATED_AT)
