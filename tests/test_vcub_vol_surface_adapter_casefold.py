...
def test_supported_vol_type_with_ocr_case_difference_persists(tmp_path) -> None:
    ...
    assert capture.metadata.vol_type == "NORMAL VOL SKEW"
    ...
    assert surface.identity.vol_type == "NORMAL VOL SKEW"
